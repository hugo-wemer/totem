...
export { default as DeleteButton } from '../../components/molecules/DeleteButton.vue'
export { default as PatientImage } from '../../components/molecules/PatientImage.vue'
export { default as TransferButton } from '../../components/molecules/TransferButton.vue'
export { default as UntransferButton } from '../../components/molecules/UntransferButton.vue'
export { default as AsymptomaticList } from '../../components/organisms/AsymptomaticList.vue'
export { default as ButtonSet } from '../../components/organisms/ButtonSet.vue'
...
export { default as Measurement } from '../../components/organisms/Measurement.vue'
export { default as PrimaryInfo } from '../../components/organisms/PrimaryInfo.vue'
export { default as Quiz } from '../../components/organisms/Quiz.vue'
...
export { default as PatientDetailsTemplate } from '../../components/templates/PatientDetailsTemplate.vue'
