...
import { DisksList, Visibility, DriveConfig, DriverContract, DriveFileStats, ContentHeaders, DriveFakeContract, LocalDriverConfig, DriveManagerContract, FakeImplementationCallback } from '@ioc:Adonis/Core/Drive';
/**
...
export declare class DriveManager extends Manager<ApplicationContract, DriverContract, DriverContract, {
    ...
    constructor(application: ApplicationContract, router: RouterContract, config: DriveConfig);
    /**
     * Validate config
     */
